...
def listar(request):
    ...
    return render(request, 'miembro/lista.html', {'miembros_permanentes':miembros_permanentes,'miembros_invitados':miembros_invitados,'app':'miembro','eventos' : Evento.get_eventos(),})
